function [s N word]=addText2space(s,texts,word,info,variableToCreateSemanticRepresentationFrom)
...
if nargin<5 variableToCreateSemanticRepresentationFrom=s.par.variableToCreateSemanticRepresentationFrom(2:end); end
...
if length(s.par.variableToCreateSemanticRepresentationFrom)>0
    eval(['info.' variableToCreateSemanticRepresentationFrom '=texts;']);
end
%else
%    info.context=texts;
%end
